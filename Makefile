...
NCURSES_SRC = src/ui4x/src/ncurses.c
NCURSES_HEADERS = src/ui4x/src/ncurses.h
...
# auto-format code
pretty-code:
	clang-format -i src/*.c src/*.h src/ui4x/src/*.c src/ui4x/src/*.h src/s3c2410/*.c $(shell ls src/s3c2410/*.h | grep -v s3c2410.h) ## s3c2410.h triggers an error
